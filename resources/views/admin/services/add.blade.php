            ...
            <div class="row gx-0">
                ...
                <div class="col-md-10">
                    <div class="maincnt-wrp">
                        ...
                        <div class="row m-0">
                            <div class="col-md-12">
                                <div class="container card card-primary p-4 shadow-lg">
                                    <form action="{{url('service/store')}}" method="post">
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            <label for="exampleInputEmail1" class="mb-1">Service Name</label>
                                            <input type="text" class="form-control"  name="title" id="exampleInputEmail1" placeholder="Enter Name" required>
                                        </div> 
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="mb-1">Description</label>
                                            <textarea class="form-control"  name="description" id="exampleInputEmail1" placeholder="Enter Name"></textarea>
                                        </div> 
                                        @csrf
